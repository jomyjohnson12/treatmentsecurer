...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2021 at 07:57 AM
...
('p10005', 1, 'yyyy', 'nmnmnm', 'mnmnnm', 's10009', 5, '2021-04-10');
...
(14, NULL, 's10007', 'dsjsdshdsj', '2021-04-10', NULL, NULL);
...
('s10009', 'Monday', '9:00:Am', '3-Hrs', 20),
('s10009', 'Wednesday', '1:00:Pm', '2-Hrs', 10);
...
('H12347', 'Kodumon west', 'Kodumon', '691555', '9922334455', 'Pathanamthitta', 'kodumonhosp@gmail.co', 'PHSC', '2021-04-10', 50);
...
('CT Scan', 'External', 'Other', 10, 'Min', 2, 'Hrs');
...
(5, 'p10005', 'H12347', 's10008', '2021-04-10');
...
(3, 'Paracetamol tab', 'H12347', 10, 'lost', 's10006', '2021-04-10');
...
(4, 'p10005', '2021-04-10', 's10006', 'H12347');
...
(8, 'Paracetamol tab', 'H12347', 100, 's10006', '2021-04-10'),
(9, 'Paracetamol tab', 'H12347', 50, 's10006', '2021-04-10');
...
(3, 'S10003', '2021-04-21', 1, 'p10001', '2021-04-10', NULL, 'H12346'),
(4, 'S10009', '2021-04-28', 1, 'p10005', '2021-04-10', 's10007', 'H12347'),
(5, 'S10009', '2021-05-03', 1, 'p10005', '2021-04-10', NULL, 'H12347');
...
--
-- Dumping data for table `opcancel`
--

INSERT INTO `opcancel` (`bno`, `cdate`, `staffid`) VALUES
(4, '2021-04-10', 's10007');
...
('P10005', 'Ram Kumar', 'RR House', 'Adoor', '691523', '8877665544', 'Pathanamthitta', 'M', 33, '445566554455', '2021-04-10', '8877665544', 's10007', 'H12347');
...
('Paracetamol tab', 'Tab', 'ddd', 'gg hh jj ', 'Mg');
...
('S10006', 'Joncy', 'JJ House', 'Kodumon', '691555', '9922445544', 'M', NULL, 'DPharm', '2 years', 'S10006'),
('S10007', 'Jomy', 'JJ House', 'Adoor', '691523', '9922334455', 'M', NULL, 'Degree', 'no exp', 'S10007'),
('S10008', 'Hari Kumar', 'HH House', 'Adoor', '691523', '7788665544', 'M', NULL, 'MLT', '4 yrs', 'S10008'),
('S10009', 'Kumar', 'KK House', 'TVM', '667755', '7865654343', 'M', 'MBBS', 'Gynacology', '5 yrs ', 'S10009');
...
('S10006', 1, 'H12347', 'Pharmacist', '2021-04-10'),
('S10007', 1, 'H12347', 'Office Staff', '2021-04-10'),
('S10008', 1, 'H12347', 'Lab Staff', '2021-04-10'),
('S10009', 1, 'H12347', 'DMO', '2021-04-10');
...
INSERT INTO `temp1` (`itemno`, `medname`, `qty`) VALUES
(1, 'Paracetamol tab', 5);
